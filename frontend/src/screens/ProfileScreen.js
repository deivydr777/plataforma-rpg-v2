...
const Header = styled.div`margin-bottom: 30px; h1 { margin: 0; font-size: 1.8em; color: #fff; }`;
...
const Button = styled.button`width: 100%; max-width: 200px; padding: 12px; border-radius: 5px; border: none; background-color: #d9534f; color: white; font-weight: bold; cursor: not-allowed;`;
