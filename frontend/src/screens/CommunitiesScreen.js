...
const generateInviteCode = () => { /* ...código de geração... */ };

// O componente agora recebe 'communities' e 'setCommunities' como propriedades
function CommunitiesScreen({ communities, setCommunities }) {
  ...
  const handleCreateCommunity = () => {
    ...
    if (trimmedName) {
      ...
      // Usamos a função 'setCommunities' que veio do App.js
    ...
    <ScreenContainer>
      ...
      {communities.length > 0 ? (
        ...
        <EmptyState>
          ...
          <p>Clique no '+' para criar a sua primeira!</p>
        </EmptyState>
      )}
    </ScreenContainer>
  );
